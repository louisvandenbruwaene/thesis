...
\hypersetup{
    pdftitle={Maximizing Edge Density Subject to Connectivity Constraints},
...
% _GUESS, _GREEN, _VIOLET), so a number's colour in the table matches its
...
\definecolor{aiMedal}{HTML}{7A5AF8}     % violet: unused by every regime colour
\newcommand{\aimedal}{\,\raisebox{-0.25pt}{\setlength{\fboxsep}{2pt}%
    \colorbox{aiMedal}{\textcolor{white}{\sffamily\bfseries\fontsize{8}{8}\selectfont AI}}}}
