...
% DOCUMENT METADATA
% ============================================================================
\title{Maximising Edge Density in Graphs Subject to Connectivity Constraints}
...
\hypersetup{
    pdftitle={Maximising Edge Density in Graphs Subject to Connectivity Constraints},
...
% ============================================================================
% PROOF STATUS
% Unchecked AI arguments are conjectures with proofs, marked [AI].
% Deductions depending on them are conjectures with conditional proofs.
% Existing author-verified arguments retain their unmarked status.
\newcommand{\aimedal}{\,[AI]}
\newcommand{\conditional}{\,[conditional]}

% --- TEMPORARY reading markers, to be deleted --------------------------------
% \readfirst{n} flags a proof picked out as a short, high-leverage read. The
% headings carrying one are numbered in the order they should be read, and the
% numbering is closed up as the author clears them. It is scaffolding
% for the author and is NOT part of the thesis. Remove it by deleting this block
% and every \readfirst call site:
%
%     grep -n readfirst preamble.tex chapters/*.tex
%
\definecolor{readmark}{RGB}{198,32,122}
\newcommand{\readfirst}[1]{\,\rb{readmark}{READ #1}}
