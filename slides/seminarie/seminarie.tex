...
\newcommand{\transrow}[2]{%
  ...
  \parbox[c]{0.235\textwidth}{\raggedright
    {\color{KULblauw3b}\bfseries #1}}%
  \hfill
  \parbox[c]{0.735\textwidth}{\centering
    \adjustbox{max width=0.72\linewidth, max totalheight=0.30\textheight}{#2}}\par}
