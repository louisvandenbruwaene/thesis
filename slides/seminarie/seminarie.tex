...
\column{0.585\textwidth}
  {\footnotesize
   \noindent\parbox[t]{1.02cm}{\strut{\color{black!40}\bfseries\scriptsize UPPER}}%
   \hspace{6pt}\parbox[t]{\dimexpr\linewidth-1.32cm\relax}{\strut\raggedright #3}\par
   \vspace{8pt}
   \noindent\parbox[t]{1.02cm}{\strut{\color{black!40}\bfseries\scriptsize LOWER}}%
   \hspace{6pt}\parbox[t]{\dimexpr\linewidth-1.32cm\relax}{\strut\raggedright #4}\par}
  \vspace{10pt}
  {\footnotesize #5}
\column{0.395\textwidth}
  \centering
  \adjustbox{max totalheight=0.33\textheight}{\resizebox{0.86\linewidth}{!}{#6}}\\[6pt]
  {\scriptsize\color{black!60} #7}
\end{columns}
\vspace{11pt}
\noindent{\scriptsize\color{vertexpurple!80!black}\bfseries COMPUTED}\par
\noindent{\footnotesize\color{black!70} #8}\par
\vfill
\end{frame}}

% the bullets inside a variant frame
\newenvironment{vlist}{\begin{itemize}\setlength{\itemsep}{4pt}%
...
\hspace*{0.5cm}\begin{minipage}{0.9\textwidth}
  ...
  {\small\color{black!70}Promotor: Dr.\ Stijn Cambie}\\[2pt]
