...
% ============================================================================
%  5.  THE CHOICE: TWO PILLS, THREE ROWS
% ============================================================================
\begin{frame}[plain]
\vfill
\begin{center}
\adjustbox{max totalheight=0.90\textheight}{\resizebox{0.96\textwidth}{!}{%
\begin{tikzpicture}[
   word/.style={font=\Large\bfseries},
   picL/.style={anchor=center},
   rowsep/.style={black!10, line width=0.7pt}]

  % ---- the two pills -------------------------------------------------------
  \begin{scope}[shift={(-3.7,5.0)}]\pillshape{pillBlue}{-14}{1.25}\end{scope}
  \begin{scope}[shift={(3.7,5.0)}]\pillshape{pillRed}{14}{1.25}\end{scope}

  % ---- row 1: multiplicity -------------------------------------------------
  \node[word, text=pillBlue!80!black, anchor=east] at (-1.9, 2.1) {simple};
  \node[word, text=pillRed!80!black,  anchor=west] at ( 1.9, 2.1) {multi};
  \begin{scope}[shift={(-5.6,2.1)}, scale=0.95]
  ...
  % ---- row 2: arity --------------------------------------------------------
  \node[word, text=pillBlue!80!black, anchor=east] at (-1.9,-0.9) {graph};
  \node[word, text=pillRed!80!black,  anchor=west] at ( 1.9,-0.9) {hyper};
  ...
  \end{scope}
  \begin{scope}[shift={(5.6,-0.9)}, scale=0.85]
    \coordinate (Ah) at (-0.9,-0.9); \coordinate (Bh) at (0.9,-0.9);
    \coordinate (Ch) at (0.9, 0.9);  \coordinate (Dh) at (-0.9,0.9);
    \begin{scope}[on background layer]
    ...
    \end{scope}
    \foreach \p in {Ah,Bh,Ch,Dh} {\node[metrostop] at (\p) {};}
  \end{scope}

  % ---- row 3: direction ----------------------------------------------------
  \node[word, text=pillBlue!80!black, anchor=east] at (-1.9,-3.9) {undirected};
  \node[word, text=pillRed!80!black,  anchor=west] at ( 1.9,-3.9) {directed};
  \begin{scope}[shift={(-5.6,-3.9)}, scale=0.95]
    \node[gvertex] (u1) at (90:0.85) {};
    \node[gvertex] (u2) at (210:0.85) {};
    \node[gvertex] (u3) at (330:0.85) {};
    \draw[gline] (u1)--(u2) (u2)--(u3) (u3)--(u1);
  \end{scope}
  \begin{scope}[shift={(5.6,-3.9)}, scale=0.95, >=Stealth]
    \node[gvertex] (v1) at (90:0.85) {};
    \node[gvertex] (v2) at (210:0.85) {};
    \node[gvertex] (v3) at (330:0.85) {};
    \draw[gdir] (v1) to[bend right=14] (v2);
    \draw[gdir] (v2) to[bend right=14] (v3);
    \draw[gdir] (v3) to[bend right=14] (v1);
    \draw[gdir] (v2) to[bend right=14] (v1);
  \end{scope}
\end{tikzpicture}}}
\end{center}
\vfill
...
\adjustbox{max totalheight=0.46\textheight, max width=\linewidth}{%
