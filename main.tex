...
Hypergraph vertex & Checked $m=2$ and $m=3$ values, the latter through the checked incidence-rank lemma, with checked attainment in both the simple and the multihypergraph model. \\
