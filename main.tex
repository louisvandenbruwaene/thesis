...
Directed multigraph & Checked exact arc value for every $n$ and $m$. The extremal classification on the quadratic branch remains conjectural, with a proposed skeleton proof. \\
...
Thirteen further statements retain the status \emph{conjecture with proposed
