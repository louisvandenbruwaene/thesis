...
Before we begin, a note on the use of artificial intelligence in this work, disclosed in full in the Contribution Statement below. I used it with verification in mind throughout. I committed the work to GitHub regularly, so that any mistake could be traced and undone, and I held the models that helped write proofs to the same discipline, asking them to correct their own mistakes just as regularly and be open about their shortcomings. Every mathematical statement and proof in this thesis I verified myself. The accompanying code I verified indirectly, through its own test suite and by cross-checking its results against independent implementations, which I judged the more reliable check for a program of this size than reading every line by hand. I hope this thesis can set an example of safe and properly verified use of AI to accelerate research.
