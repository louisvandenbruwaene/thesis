...
Directed quadratic bounds & Checked elementary arc proof valid at every $n$, with the vertex analogue and the hypergraph extensions proposed. The simple-digraph asymptotic also follows from Huang and Lyu \cite{HuangLyu26} with the displayed lower construction. \\
\bottomrule
\end{tabularx}
\end{center}
