...
\code{program/make\_figures.py} & Regenerates the computational figures and their underlying data with fixed seeds. \\
...
Multigraph vertex, parallel copies distinct & Exact block-knapsack formulation and all $n,m\le8$; order $\Theta(m^2n)$ (\Cref{thm:multi-vertex-blocks,prop:multi-vertex-upper}) & Determine the asymptotic constant and the optimal $2$-connected blocks. \\
\end{lstlisting}
