...
\begin{scope}[xshift=11cm]
  \stations
  \coordinate (Helc) at (1.49,3.49);
  \coordinate (Hmcj) at (4.57,3.43);
  \coordinate (Hedm) at (3.46,3.62);
  \coordinate (Helm) at (2.54,6.38);
...
\begin{scope}[xshift=11cm]
  \stations
  \coordinate (Hnel) at (0.43,5.57);
  \coordinate (Helm) at (4.00,6.80);
  \begin{scope}[on background layer]
    \draw[dmetro, metroA, opacity=0.28, line width=2.2pt] (Sa) -- (Se);
    \draw[dmetro, metroA, opacity=0.28, line width=2.2pt] (Sa) -- (Sd);
    \draw[dmetro, metroB, opacity=0.28, line width=2.2pt] (Sm) -- (Sn);
    \draw[dmetro, metroB, opacity=0.28, line width=2.2pt] (Sm) -- (Sj);
    \draw[dmetro, metroC, opacity=0.28, line width=2.2pt] ($(Sl)+(0.14,-0.14)$) -- ($(Se)+(0.14,-0.14)$);
    \draw[dmetro, metroC, opacity=0.28, line width=2.2pt] (Sl) -- (Sc);
    \draw[dmetro, metroD, opacity=0.28, line width=2.2pt] (Sd) -- (Se);
    \draw[dmetro, metroD, opacity=0.28, line width=2.2pt] (Sd) -- (Sm);
    \draw[dmetro, metroF] (Se) -- (Sn);
    \draw[dmetro, metroF] (Se) -- (Sl);
    \draw[dmetro, metroH] ($(Sl)+(-0.14,0.14)$) -- ($(Se)+(-0.14,0.14)$);
    \draw[dmetro, metroH] (Sl) -- (Sm);
    \draw[dmetro, metroG, opacity=0.28, line width=2.2pt] (Sc) -- (Sm);
    \draw[dmetro, metroG, opacity=0.28, line width=2.2pt] (Sc) -- (Sj);
    \draw[dmetro, metroE, opacity=0.28, line width=2.2pt] (Sd) -- (Sl);
    \draw[dmetro, metroE, opacity=0.28, line width=2.2pt] (Sd) -- (Sj);
  \end{scope}
  \draw[flowarc] (Se) -- (Hnel);
  \draw[flowarc] (Hnel) -- (Sl);
  \draw[flowarc] (Sl) -- (Helm);
  \draw[flowarc] (Helm) -- (Sm);
  \node[gate] at (Hnel) {$h_{\textcolor{metroF}{\bullet}}$};
  \node[gate] at (Helm) {$h_{\textcolor{metroH}{\bullet}}$};
  \drawstops
  \node[font=\small] at (4,-1.4) {(b)};
