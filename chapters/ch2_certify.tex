...
\begin{tikzpicture}[>=Stealth,
   ...
   tri/.style={line width=1.0pt, draw opacity=0.6},
...
\begin{scope}[xshift=9.3cm]
  ...
  % hyperedge triangles in the same colours as panel (a), so each helper sits
  % visibly inside its three members and the two panels read alike
  \draw[tri, metroA] (u)--(a)--(b)--cycle;
  \draw[tri, metroB] (b)--(c)--(v)--cycle;
  \draw[tri, metroC] (u)--(d)--(e)--cycle;
  \draw[tri, metroD] (e)--(f)--(v)--cycle;
  \draw[tri, metroE] (b)--(w)--(e)--cycle;
