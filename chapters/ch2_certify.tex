...
\begin{tikzpicture}[scale=0.92, >=Stealth,
   ...
   dmetro/.style={metro, line width=3.0pt,
                  postaction={decorate, decoration={markings,
                    mark=at position 0.57 with {\arrow{Stealth[length=2.8mm]}}}}},
...
\begin{scope}[xshift=11cm]
  ...
  % helper-point gates on the ridden rails, in the 2.6 style
  \node[gate] at (7,5)     {$h_{\textcolor{metroB}{\bullet}}$};
  \node[gate] at (6.2,3.4) {$h_{\textcolor{metroG}{\bullet}}$};
  \node[gate] at (2,4)     {$h_{\textcolor{metroC}{\bullet}}$};
  \node[gate] at (1,5)     {$h_{\textcolor{metroF}{\bullet}}$};
  \node[gate] at (4,6)     {$h_{\textcolor{metroH}{\bullet}}$};
  \node[gate] at (4,4)     {$h_{\textcolor{metroE}{\bullet}}$};
  \node[gate] at (3,3)     {$h_{\textcolor{metroD}{\bullet}}$};
  \drawstops
...
rail a route rides and marking its one-route gate $h_{\bullet}$, in that line's
colour, the directed turnstile of \Cref{fig:dir-hyper-gadget}. Two edge-disjoint
directed Berge routes from $v$ to $u$ survive. The long route
