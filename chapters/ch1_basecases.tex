...
\begin{conjecture}[Directed vertex problem, leading constant and order, with proof,\aimedal\readfirst{3}]\label{thm:dir-vertex-linear-error}
...
\begin{conjecture}[Directed multigraph value, every $n$ and $m$, with proof,\aimedal\readfirst{1}]\label{thm:dir-multi-full}
For all $n \ge 2$ and $m \ge 2$,
\[
...
\begin{conjecture}[The directed hypergraph constant, with proof,\aimedal\readfirst{9}]\label{thm:dir-hyper-constant}
