...
\begin{conjecture}[The quadratic bound with a linear error, with proof,\aimedal]\label{thm:dir-arc-linear-error}
...
\begin{conjecture}[Directed multigraph value, every $n$ and $m$, with proof,\aimedal]\label{thm:dir-multi-full}
For all $n \ge 2$ and $m \ge 2$,
\[
