...
The \emph{size} $|E(G)| = \sum_{u \ne v} \mu(u,v)$ counts the edges with their multiplicity, and it is the very quantity this thesis tries to make as large as possible under certain constraints.
