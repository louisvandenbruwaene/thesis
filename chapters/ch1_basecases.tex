...
\begin{tikzpicture}[>=Stealth,
  ...
  \end{scope}
\end{tikzpicture}}
\caption{The four models of \Cref{fig:three-models} with direction added. A directed hyperedge is a star from one tail to its heads; repetition creates parallel copies of those arcs.}
