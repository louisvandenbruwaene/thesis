...
\caption{Three arc-disjoint $u\to v$ routes (coloured) and the matching three-arc directed cut (red). Thus $\lambda(u,v)=3$, meeting the degree bound $\min(d^+(u),d^-(v))=3$.}
...
question. This chapter proves the short cases before the machine treats the
