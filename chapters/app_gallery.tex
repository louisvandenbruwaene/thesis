...
\begin{figure}[htbp]
    ...
    tie, matching the double star at $24$ arcs as one of the three families the
    $n = 7$ classification of \Cref{rem:odd-step-roadmap} identifies. The final panel is the
