...
It lies between the conjectured $(m-2)/2$ and the proved $4(m-1)$, which holds at every $n$.
...
Two block sweeps and one hypergraph enumeration use separate scripts in \code{program/scripts/}.
