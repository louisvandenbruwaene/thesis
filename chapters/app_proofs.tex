...
\begin{conjecture}[A sparse reachability skeleton always exists, with proof,\aimedal]\label{lem:reach-skeleton}
...
\begin{conjecture}[Deleting the smaller half of every vertex, with proof,\aimedal]\label{lem:smaller-half-deletion}
...
\begin{conjecture}[The counting core, with proof,\aimedal]\label{lem:two-step-budget}
...
\begin{conjecture}[Menger for multihypergraphs, with proof,\aimedal]\label{thm:menger-hyper}
...
\begin{conjecture}[Cut induction for multihypergraphs, with proof,\aimedal]\label{lem:hyper-cut-induction}
...
\begin{conjecture}[Simplicity is free for $r \ge 3$, with proof,\aimedal]\label{thm:simple-hyper-edge}
