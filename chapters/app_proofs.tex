...
At $m=6$, $n=6$, and $r=3$, all $125\,970$ simple twelve-hyperedge candidates are infeasible.
...
The simple hypergraph cell at $m=6$, $n=6$ is such a $\le$ point.
It reads $\le 12$ because the exhaustive solve did not finish there, while the twelve-hyperedge enumeration above fixes the true maximum at $11$.
