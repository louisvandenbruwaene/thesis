...
\subsection{The historical $m$-free model}\label{sec:mstar-model}
...
\Cref{ch:certify} states that the search avoids most calls to the checker by tracking a bound on $\lambda^{\max}$ rather than recomputing it. This section records how, and how the shortcut is held to the value the naive implementation would have returned.
