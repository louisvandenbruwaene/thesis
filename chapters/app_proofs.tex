...
Rendering and recomputing are separate operations. The third command above reads
the recorded values and draws them. It never starts a search, so an entry the file
does not hold is reported as an error rather than computed. Passing
