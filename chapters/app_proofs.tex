...
At $r = 2$ the theorem speaks of multigraphs, where the incidence convention of
\Cref{sec:incidence-convention} makes $q$ parallel edges $q$ distinct one-step
routes. It gives $K_3(n) = 2(n-1)$, the same number as the multigraph edge value
of \Cref{thm:multigraph-edge}, and \Cref{cor:multi-vertex-m3} below records that
specialisation. The proof of
