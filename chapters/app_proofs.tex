...
The checked incidence-rank argument establishes the hypergraph vertex value at $m=3$.
...
\begin{conjecture}[The two directed feasible families at $m=2$, with proof,\aimedal\readfirst{1}]\label{lem:directed-m2-families}
...
\begin{conjecture}[Quadratic bound and bipartisation, with proof,\aimedal\readfirst{2}]\label{prop:dir-arc-stability}
...
\begin{conjecture}[A minimal bipartite skeleton has no long path, with proof,\aimedal\readfirst{3}]\label{lem:skeleton-shallow}
...
\begin{conjecture}[The multigraph incidence value at $m = 3$, with proof,\aimedal\readfirst{4}]\label{cor:multi-vertex-m3}
...
\begin{conjecture}[A bouquet of thickened cliques, and how it beats the thickened tree, with proof,\aimedal\readfirst{9}]\label{thm:clique-chain-vertex}
...
\begin{conjecture}[An upper bound of the same order, with proof,\aimedal\readfirst{8}]\label{prop:multi-vertex-upper}
...
\begin{conjecture}[The objective in closed form, with proof,\aimedal\readfirst{10}]\label{lem:multi-vertex-objective}
...
\begin{conjecture}[Splitting the directed vertex measure, with proof,\aimedal\readfirst{5}]\label{lem:multi-vertex-split-dir}
...
\begin{conjecture}[The directed multigraph incidence value, with proof,\aimedal\readfirst{6}]\label{cor:dir-multi-incidence}
For every $n \ge 2$,
\[
...
\begin{conjecture}[The directed incidence value is a block problem too, with proof,\aimedal\readfirst{7}]\label{prop:dir-multi-vertex-blocks}
