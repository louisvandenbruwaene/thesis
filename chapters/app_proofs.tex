...
\begin{sidewaysfigure}[p]
    ...
    \caption{The eight hypergraph-model variants at $m=6$. In the simple undirected edge panel, the proved upper bound is $10$ at $n=5$ and $12$ at $n=6$. The exact values are $8$ and $11$.}
...
The prefix $\le$ marks a proved upper bound without a matching construction at that point.
