...
\paragraph{How to read this appendix.} \Cref{thm:menger,thm:gomory-hu} and Mader's theorem are classical and may be skipped by readers who trust the cited results. The remaining sections contain the load-bearing directed and hypergraph arguments, and \Cref{sec:transcripts} records the source, commands, tests, and finite-output logs.
