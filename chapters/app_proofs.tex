...
The constructions establish a quadratic-in-$m$ lower bound once many blocks
fit. A matching upper bound would require the next, unchecked proposition; it
comes from the underlying simple graph rather than cycle rank.
...
If both the preceding lower construction and the next proposed upper bound are
eventually verified, then first letting $n/m\to\infty$ so that optimised blocks
