...
\begin{conjecture}[A sparse reachability skeleton always exists, with proof,\aimedal\readfirst{3}]\label{lem:reach-skeleton}
...
This section gives conditional proofs of the two proposed $m=2$ values.
The vertex upper bound uses \Cref{lem:reach-skeleton}, whose proposed proof remains unchecked.
...
\begin{proof}[Conditional proof of \Cref{thm:dir-vertex-m2-exact}]
...
\begin{proof}[Conditional proof of \Cref{thm:dir-arc-m2-exact}]
...
\begin{conjecture}[The counting core, with proof,\aimedal\readfirst{1}]\label{lem:two-step-budget}
...
\begin{proof}[Proposed proof of \Cref{thm:dir-arc-linear-error}]
...
\begin{conjecture}[The directed multigraph value at $n = 7$, $m = 3$, with proof,\aimedal]\label{cor:dir-multi-n7}
$L_3^{\mathrm{dir}}(7) = 24$.
\end{conjecture}
...
\begin{conjecture}[Incidence rank lemma, with proof,\aimedal]\label{lem:incidence-rank}
...
\begin{conjecture}[Directed hypergraphs: first bounds, with proof,\aimedal]\label{prop:dir-hyper-first}
...
\begin{conjecture}[Bounded outgoing hyperedge count, with proof,\aimedal]\label{const:bounded-outdegree-hyper}
...
\begin{conjecture}[Backward is the reverse of forward, with proof,\aimedal]\label{lem:dir-hyper-duality}
...
\begin{conjecture}[The general model obeys the forward bound, with proof,\aimedal]\label{prop:dir-hyper-general}
...
\begin{conjecture}[The general orientation model shares the constant, with proof,\aimedal]\label{thm:dir-hyper-general-constant}
