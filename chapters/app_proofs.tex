...
\paragraph{How to read this appendix.} \Cref{thm:menger,thm:gomory-hu} and Mader's theorem are classical and may be skipped by readers who trust the cited results, as may the short proofs of the base-case values that follow them. The remaining sections contain the load-bearing directed and hypergraph arguments, and \Cref{sec:transcripts} records the source, commands, tests, and finite-output logs.
...
repository at \url{https://github.com/louisvandenbruwaene/thesis}, and the
submitted snapshot should record an immutable commit. From \code{program/},
