...
Rendering and recomputing are separate operations. The command above reads the
recorded values and draws them. It never starts a search, so an entry the file
