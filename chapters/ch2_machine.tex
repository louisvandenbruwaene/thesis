...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{All twelve variants at $m=3$ and $m=6$. Rows select the model and columns the direction and separation, while colours encode theorem, conjecture, or interpolation, while filled squares are exact finite values and open circles are witnesses.}
