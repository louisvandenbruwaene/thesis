...
The base cases $n \le 7$ of the directed $m = 2$ vertex theorem (\Cref{thm:dir-vertex-m2-exact}) are the finite checks the induction of \Cref{app:proofs} depends on, the arc theorem following from it there, and they sit just past where blind enumeration of digraphs is tractable.
