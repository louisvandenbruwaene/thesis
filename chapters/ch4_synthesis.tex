...
agree exactly once $n>r$ remains open; the thesis uses the forward convention
...
Directed simple vertex, $m\ge3$ & $k_m^{\mathrm{dir}}(n)=n^2/4+\Theta_m(n)$ (\Cref{thm:dir-vertex-linear-error}) & Decide whether its exact value equals the arc value; an arc upper bound does not transfer. \\
...
Undirected simple vertex, $m\ge6$ & Block formulation and $m/2<c_m\le2(m-1)$ & Determine $c_m$; the likely next structure is triconnected rather than merely blockwise. \\
