...
confirmed those results for small graphs and then searched the many remaining possibilities for dense graphs.
...
The directed arc problem is a race between a hub with $m(n-1)$ arcs and an augmented bipartite construction with $\floor{(n+m-2)^2/4}$ arcs (\Cref{const:directed-hub,const:augmented-bipartite}). They cross near $n=9$ at $m=3$.
