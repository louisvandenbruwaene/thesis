...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=3469,
  linerange={3469-4364}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=4365,
  linerange={4365-4913}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=4914,
  linerange={4914-5448}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=5449,
  linerange={5449-5735}]{program/erdos915_unified.py}
