...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=755,
  linerange={755-1268}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=1269,
  linerange={1269-2310}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=2311,
  linerange={2311-2548}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=2549,
  linerange={2549-3468}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=3469,
  linerange={3469-4370}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=4371,
  linerange={4371-4919}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=4920,
  linerange={4920-5454}]{program/erdos915_unified.py}
...
\lstinputlisting[style=sourcelisting, language=Python, firstnumber=5455,
  linerange={5455-5741}]{program/erdos915_unified.py}
